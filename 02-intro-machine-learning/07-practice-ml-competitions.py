# Practice 7 - Machine Learning Competition

# Build a Random Forest model with all of your data (X and y).
#
# Read in the "test" data, which doesn't include values for the target.
...
#
# Optionally, come back to see if you can improve your model by adding features or changing your model.
...
output.to_csv('07-practice-ml-submission.csv', index=False)