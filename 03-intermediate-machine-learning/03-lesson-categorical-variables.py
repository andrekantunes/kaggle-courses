...
# If people responded to a survey about which what brand of car they owned,
# the responses would fall into categories like "Honda", "Toyota", and "Ford".
...
# 2 - Label Encoding
# Every day, Never, Rarely, Most days -> 3,0,1,2 (Makes sense some cases)

# 3 - One Hot Encoding
# Red, Yellow, Green -> New columns with 1 and 0 for the data
